...
<body class="text-center">
  ...
  <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM cliente WHERE cedula = '$cedula' AND password = '$password'";
      $result = $db->query($sql);
      $row = $result->fetch();
      if ($row) {
        session_start();
    ...
    ?>
    <form method="post">
      <img class="mb-4" src="../img/driver.svg" alt="" width="72" height="57">
      ...
      <p>No tengo una cuenta.<a href="./registrar_usuario.php">Registrarme</a></p>
